$('#examclass-class_id').change(function(e){
	...
	success: function(response){
		$('#examclass-section_id').html(response);
		$('#examclass-section_id').removeAttr("disabled");
		}
	});
});
...
var counter = 0;
var slctionsub = $('#examclass-class_id').html();
var slctiontchr = $('#examclass-section_id').html();
	$(function(){
