		...
		$('#finalexam-class_id').change(function(e){
			var clasign = $(this).val();
			$.ajax({
			type :'POST',
			data: {class_ids: clasign},
			url:'/final-exam/getsection',
	  ...
	  b.click(function() {
		...
		$('.add_subjectsd').click(function(e){
			...
			exam_dt.each(function() {
				...
				var mikers = $(this).val();
			/* 	if(mikers == ''){
					$(this).parent('div').find('.help-block_second').html('Please enter exam Date.');
					error++;
				}else{
					$(this).parent('div').find('.help-block_second').html('');
				} */
			});
			...
			marksaad.each(function() {
				...
				/* if(mikerss == ''){
					$(this).parent('div').find('.help-block_second').html('Please enter Maximum Marks.');
					error++;
				}else{
					$(this).parent('div').find('.help-block_second').html('');
				} */
