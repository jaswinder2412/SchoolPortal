...
use backend\models\AddExam_search;
...
/**
 * AddExamController implements the CRUD actions for AddExam model.
 */
class AddExamController extends Controller
{
   ...
   public function behaviors()
    ...
    /**
     * Lists all AddExam models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new AddExam_search();
    ...
    /**
     * Displays a single AddExam model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Finds the AddExam model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return AddExam the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = AddExam::findOne($id)) !== null) {
            return $model;
        } else {
