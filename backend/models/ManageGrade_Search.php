...
/**
 * ManageGrade_Search represents the model behind the search form about `backend\models\ManageGrade`.
 */
class ManageGrade_Search extends ManageGrade
{
    /**
     * @inheritdoc
     */
