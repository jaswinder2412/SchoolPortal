...
/**
 * AddClass_search represents the model behind the search form about `backend\models\AddClass`.
 */
class AddClass_search extends AddClass
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [['class_name', 'school_id', 'created', 'updated'], 'safe'],
        ];
    }
