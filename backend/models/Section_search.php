...
/**
 * Section_search represents the model behind the search form about `backend\models\Section`.
 */
class Section_search extends Section
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [['section_name', 'school_id', 'created', 'updated'], 'safe'],
        ];
    }
