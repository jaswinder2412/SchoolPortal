...
?> 
	...
	<div class="col-md-6 mar-left-non">
		<div class="box box-danger">
			...
			<?php if(Yii::$app->user->identity->role_id == '5'){ ?>
			 ...
			 <div class="form-group field-announcementsparent-class_id">
				<label>Select Class</label>
				<div class="input-group">
					<div class="input-group-addon"><i class="fa fa-user"></i></div>
					<select id="announcementsparent-class_id" class="form-control" name="AnnouncementsParent[class_id]" disabled="disabled">
						<?php 
			...
			<div class="form-group">
			 <div class="form-group field-announcementsparent-class_id">
				...
				<div class="input-group">
					<div class="input-group-addon"><i class="fa fa-user"></i></div>
					<select id="announcementsparent-class_id" class="form-control" name="AnnouncementsParent[class_id]" multiple="multiple" disabled="disabled">
						<?php 
						$goting = explode(',',$model->class_id);
							foreach($mateods as $key => $vlues){
								if(in_array($key,$goting)){
 ...
 <div class="form-group">
	 <div class="form-group field-announcementsparent-student_id">
	
		<select id="announcementsparent-student_id" class="form-control" name="AnnouncementsParent[student_id][]"  multiple="multiple" readonly="true">
